...
# main game loop
pause_text = pygame.font.SysFont('Consolas', 24).render('You Have Paused The Game! Press s to continue!', True, pygame.color.Color('White'))
...
while (True):
    ...
    for event in pygame.event.get():
        ...
        if state == RUNNING:
            ...
            ## clear the screen
            screen.fill(pygame.Color(0, 197, 205, 255))
